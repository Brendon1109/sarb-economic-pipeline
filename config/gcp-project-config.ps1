# SARB Economic Pipeline - GCP Project Configuration (PowerShell)
...
Write-Host "GCP Project Configuration Loaded:" -ForegroundColor Green
Write-Host "Project ID: $PROJECT_ID" -ForegroundColor Blue
Write-Host "BigQuery Console: $BIGQUERY_CONSOLE_URL" -ForegroundColor Blue
Write-Host "Assessment URL: $ASSESSOR_PROJECT_URL" -ForegroundColor Blue
